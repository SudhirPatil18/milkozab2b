...
function HeadAdminManageShops() {
  ...
  const fetchShops = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/headadmin/shops?${params}`, {
  ...
  const toggleShopBlock = async (shopId, currentStatus) => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/headadmin/shops/${shopId}/block`, {
        method: 'PUT',
        headers: getAuthHeaders(),
  ...
  const toggleShopVerification = async (shopId, currentStatus) => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/headadmin/shops/${shopId}/verify`, {
        method: 'PUT',
        headers: getAuthHeaders(),
  ...
  const deleteShop = async (shopId, shopName) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/headadmin/shops/${shopId}`, {
        method: 'DELETE',
        headers: getAuthHeaders(),
      });
...
export default HeadAdminManageShops;
