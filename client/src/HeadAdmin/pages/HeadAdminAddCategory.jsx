...
function HeadAdminAddCategory() {
  ...
  const fetchCategories = async () => {
    setLoading(true)
    try {
      const response = await fetch('https://api.milkoza.in/api/headadmin/categories', {
  ...
  const handleEditCategory = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://api.milkoza.in/api/headadmin/categories/${editingCategory._id}`, {
        method: 'PUT',
        headers: {
          'Authorization': getAuthHeaders().Authorization
        },
  ...
  const handleDeleteCategory = async (id) => {
    if (window.confirm('Are you sure you want to delete this category?')) {
      setLoading(true)
      try {
        const response = await fetch(`https://api.milkoza.in/api/headadmin/categories/${id}`, {
          method: 'DELETE',
          headers: getAuthHeaders()
        })
        const data = await response.json()
...
export default HeadAdminAddCategory
